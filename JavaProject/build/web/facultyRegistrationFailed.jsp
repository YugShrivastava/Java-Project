<%-- 
    Document   : facultyRegistrationFailed
    Created on : 24 Sep, 2024, 9:02:44 PM
    Author     : YUG
--%>
...
<html>
    ...
    <body>
        ...
        <h1>Faculty Registration Failed</h1>
        <h2>Try Again</h2>
        <form action="AddFaculty" method="post">
            <table>
                ...
                <tr>
                    ...
                    <td><input type="text" name="facultycontact" placeholder="Enter Faculty Contact" /></td>
                </tr>
                <tr>
